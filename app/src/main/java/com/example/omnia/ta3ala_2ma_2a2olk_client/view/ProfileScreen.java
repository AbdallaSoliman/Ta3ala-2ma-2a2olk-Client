...
public class ProfileScreen extends AppCompatActivity implements View.OnClickListener, SaveImageCallBack, ProfileInterface.view {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idstr = manager.getString(userDetails, "id", "no");
            ...
            public void onClick(View view) {
                ...
                alertDialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        presenter.updateUsername(getApplicationContext(),emails, usernames, firstnames, lastnames, genders , id , image , password  );
